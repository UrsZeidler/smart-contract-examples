...
+		'		      <div class="contract_attribute_value" id="'+this.prefix+'Library_employeeCount_value"> </div>'
+		'		    </div>'
+		'		    <div class="contract_attribute" id="'+this.prefix+'Library_contract_attribute_userCount"> userCount:'
+		'		      <div class="contract_attribute_value" id="'+this.prefix+'Library_userCount_value"> </div>'
+		'		    </div>'
+		'		    <div class="contract_attribute" id="'+this.prefix+'Library_contract_attribute_activeUserCount"> activeUserCount:'
+		'		      <div class="contract_attribute_value" id="'+this.prefix+'Library_activeUserCount_value"> </div>'
+		'		    </div>'
+		'		    <div class="contract_attribute" id="'+this.prefix+'Library_contract_attribute_bookCount"> bookCount:'
+		'		      <div class="contract_attribute_value" id="'+this.prefix+'Library_bookCount_value"> </div>'
+		'		    </div>'
+		'		    <div class="contract_attribute" id="'+this.prefix+'Library_contract_attribute_activeBooksCount"> activeBooksCount:'
+		'		      <div class="contract_attribute_value" id="'+this.prefix+'Library_activeBooksCount_value"> </div>'
+		'		    </div>'
+		'		    <div class="contract_attribute" id="'+this.prefix+'Library_contract_attribute_managerCount"> managerCount:'
+		'		      <div class="contract_attribute_value" id="'+this.prefix+'Library_managerCount_value"> </div>'
+		'		    </div>'
+		'		'
+		'		<div class="Value_Mapping" id="'+this.prefix+'Library_contract_attribute_managers">mapping  managers:'
+		'				<input type="text" id="'+this.prefix+'Library_contract_attribute_managers_input">(address)'
+		'		    	<div class="Mapping_value" id="'+this.prefix+'Library_contract_attribute_address"> bool:'
+		'		      		<div class="contract_attribute_value" id="'+this.prefix+'Library_managers_value"> </div>'
+		'		    	</div>'
+		'		  </div>'
+		'		<div class="Value_Mapping" id="'+this.prefix+'Library_contract_attribute_employees">mapping  employees:'
+		'				<input type="text" id="'+this.prefix+'Library_contract_attribute_employees_input">(address)'
+		'		    	<div class="Mapping_value" id="'+this.prefix+'Library_contract_attribute_address"> bool:'
+		'		      		<div class="contract_attribute_value" id="'+this.prefix+'Library_employees_value"> </div>'
+		'		    	</div>'
+		'		  </div>'
+		'		<div class="Struct_Mapping" id="'+this.prefix+'Struc_Library_contract_attribute_users">struc mapping  users:'
+		'				<input type="number" id="'+this.prefix+'Library_contract_attribute_users_input">(uint)'
+		'		    	<div class="Struct_attribute" id="'+this.prefix+'Library_contract_attribute_users_userState"> userState:'
+		'		      		<div class="Struct_attribute_value" id="'+this.prefix+'Library_users_userState_value"> </div>'
+		'		    	</div>'
+		'		    	<div class="Struct_attribute" id="'+this.prefix+'Library_contract_attribute_users_userName"> userName:'
+		'		      		<div class="Struct_attribute_value" id="'+this.prefix+'Library_users_userName_value"> </div>'
+		'		    	</div>'
+		'		    	<div class="Struct_attribute" id="'+this.prefix+'Library_contract_attribute_users_userId"> userId:'
+		'		      		<div class="Struct_attribute_value" id="'+this.prefix+'Library_users_userId_value"> </div>'
+		'		    	</div>'
+		'		    	<div class="Struct_attribute" id="'+this.prefix+'Library_contract_attribute_users_borrowedBooks"> borrowedBooks:'
+		'		      		<div class="Struct_attribute_value" id="'+this.prefix+'Library_users_borrowedBooks_value"> </div>'
+		'		    	</div>'
+		'		    	<div class="Struct_attribute" id="'+this.prefix+'Library_contract_attribute_users_borrowedBooksCount"> borrowedBooksCount:'
+		'		      		<div class="Struct_attribute_value" id="'+this.prefix+'Library_users_borrowedBooksCount_value"> </div>'
+		'		    	</div>'
+		'		  </div>'
+		'		<div class="Struct_Mapping" id="'+this.prefix+'Struc_Library_contract_attribute_books">struc mapping  books:'
+		'				<input type="number" id="'+this.prefix+'Library_contract_attribute_books_input">(uint)'
+		'		    	<div class="Struct_attribute" id="'+this.prefix+'Library_contract_attribute_books_bookTitel"> bookTitel:'
+		'		      		<div class="Struct_attribute_value" id="'+this.prefix+'Library_books_bookTitel_value"> </div>'
+		'		    	</div>'
+		'		    	<div class="Struct_attribute" id="'+this.prefix+'Library_contract_attribute_books_bookId"> bookId:'
+		'		      		<div class="Struct_attribute_value" id="'+this.prefix+'Library_books_bookId_value"> </div>'
+		'		    	</div>'
+		'		    	<div class="Struct_attribute" id="'+this.prefix+'Library_contract_attribute_books_bookState"> bookState:'
+		'		      		<div class="Struct_attribute_value" id="'+this.prefix+'Library_books_bookState_value"> </div>'
+		'		    	</div>'
+		'		    	<div class="Struct_attribute" id="'+this.prefix+'Library_contract_attribute_books_currentOwner"> currentOwner:'
+		'		      		<div class="Struct_attribute_value" id="'+this.prefix+'Library_books_currentOwner_value"> </div>'
+		'		    	</div>'
+		'		  </div>'
+		'		<div class="Value_Mapping" id="'+this.prefix+'Library_contract_attribute_usersAdresses">mapping  usersAdresses:'
+		'				<input type="text" id="'+this.prefix+'Library_contract_attribute_usersAdresses_input">(address)'
+		'		    	<div class="Mapping_value" id="'+this.prefix+'Library_contract_attribute_address"> uint:'
+		'		      		<div class="contract_attribute_value" id="'+this.prefix+'Library_usersAdresses_value"> </div>'
+		'		    	</div>'
+		'		  </div>'
+		'		    <button id="'+this.prefix+'Library_updateAttributes" onclick="'+this.prefix+'LibraryController._updateAttributes()">update Library attributes</button>'
+		'		  </div>'
+		'		  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_returnBook_uint_address">'
+		'		Library_returnBook:'
+		'			  <div class="function_parameter">id<input type="number" id="'+this.prefix+'Library_returnBook_uint_address_id"></div>'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_returnBook_uint_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_returnBook_uint_address" onclick="'+this.prefix+'LibraryController.Library_returnBook_uint_address()">execute Library_returnBook</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_returnBook_uint_address_res"></div>'
+		'		  </div>'
+		'		  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_getBook_uint">'
+		'		Library_getBook:'
+		'			  <div class="function_parameter">_id<input type="number" id="'+this.prefix+'Library_getBook_uint__id"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_getBook_uint" onclick="'+this.prefix+'LibraryController.Library_getBook_uint()">execute Library_getBook</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_getBook_uint_res"></div>'
+		'		  </div>'
+		'		  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_registerManager_address">'
+		'		Library_registerManager:'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_registerManager_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_registerManager_address" onclick="'+this.prefix+'LibraryController.Library_registerManager_address()">execute Library_registerManager</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_registerManager_address_res"></div>'
+		'		  </div>'
+		'		  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_unregisterManager_address">'
+		'		Library_unregisterManager:'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_unregisterManager_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_unregisterManager_address" onclick="'+this.prefix+'LibraryController.Library_unregisterManager_address()">execute Library_unregisterManager</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_unregisterManager_address_res"></div>'
+		'		  </div>'
+		'		  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_registerEmployee_address">'
+		'		Library_registerEmployee:'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_registerEmployee_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_registerEmployee_address" onclick="'+this.prefix+'LibraryController.Library_registerEmployee_address()">execute Library_registerEmployee</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_registerEmployee_address_res"></div>'
+		'		  </div>'
+		'		  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_unregisterEmployee_address">'
+		'		Library_unregisterEmployee:'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_unregisterEmployee_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_unregisterEmployee_address" onclick="'+this.prefix+'LibraryController.Library_unregisterEmployee_address()">execute Library_unregisterEmployee</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_unregisterEmployee_address_res"></div>'
+		'		  </div>'
+		'		  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_registerUser_address_string">'
+		'		Library_registerUser:'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_registerUser_address_string__address"></div>'
+		'			  <div class="function_parameter">_name<input type="text" id="'+this.prefix+'Library_registerUser_address_string__name"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_registerUser_address_string" onclick="'+this.prefix+'LibraryController.Library_registerUser_address_string()">execute Library_registerUser</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_registerUser_address_string_res"></div>'
+		'		  </div>'
+		'		  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_unregisterUser_address">'
+		'		Library_unregisterUser:'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_unregisterUser_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_unregisterUser_address" onclick="'+this.prefix+'LibraryController.Library_unregisterUser_address()">execute Library_unregisterUser</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_unregisterUser_address_res"></div>'
+		'		  </div>'
+		'		  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_addBook_string">'
+		'		Library_addBook:'
+		'			  <div class="function_parameter">_titel<input type="text" id="'+this.prefix+'Library_addBook_string__titel"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_addBook_string" onclick="'+this.prefix+'LibraryController.Library_addBook_string()">execute Library_addBook</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_addBook_string_res"></div>'
+		'		  </div>'
+		'		  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_changeBookState_uint_uint">'
+		'		Library_changeBookState:'
+		'			  <div class="function_parameter">id<input type="number" id="'+this.prefix+'Library_changeBookState_uint_uint_id"></div>'
+		'			  <div class="function_parameter">_state<input type="number" id="'+this.prefix+'Library_changeBookState_uint_uint__state"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_changeBookState_uint_uint" onclick="'+this.prefix+'LibraryController.Library_changeBookState_uint_uint()">execute Library_changeBookState</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_changeBookState_uint_uint_res"></div>'
+		'		  </div>'
+		'		  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_borrowBook_uint_address">'
+		'		Library_borrowBook:'
+		'			  <div class="function_parameter">id<input type="number" id="'+this.prefix+'Library_borrowBook_uint_address_id"></div>'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_borrowBook_uint_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_borrowBook_uint_address" onclick="'+this.prefix+'LibraryController.Library_borrowBook_uint_address()">execute Library_borrowBook</button>'
...
;
	...
	*/
	this.createLibrary_returnBook_uint_addressGui=function() {
		return 		'  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_returnBook_uint_address">'
+		'		Library_returnBook:'
+		'			  <div class="function_parameter">id<input type="number" id="'+this.prefix+'Library_returnBook_uint_address_id"></div>'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_returnBook_uint_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_returnBook_uint_address" onclick="'+this.prefix+'LibraryController.Library_returnBook_uint_address()">execute Library_returnBook</button>'
...
;
	...
	*/
	this.createLibrary_getBook_uintGui=function() {
		return 		'  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_getBook_uint">'
+		'		Library_getBook:'
+		'			  <div class="function_parameter">_id<input type="number" id="'+this.prefix+'Library_getBook_uint__id"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_getBook_uint" onclick="'+this.prefix+'LibraryController.Library_getBook_uint()">execute Library_getBook</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_getBook_uint_res"></div>'
...
;
	...
	*/
	this.createLibrary_registerManager_addressGui=function() {
		return 		'  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_registerManager_address">'
+		'		Library_registerManager:'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_registerManager_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_registerManager_address" onclick="'+this.prefix+'LibraryController.Library_registerManager_address()">execute Library_registerManager</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_registerManager_address_res"></div>'
...
;
	...
	*/
	this.createLibrary_unregisterManager_addressGui=function() {
		return 		'  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_unregisterManager_address">'
+		'		Library_unregisterManager:'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_unregisterManager_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_unregisterManager_address" onclick="'+this.prefix+'LibraryController.Library_unregisterManager_address()">execute Library_unregisterManager</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_unregisterManager_address_res"></div>'
...
;
	...
	*/
	this.createLibrary_registerEmployee_addressGui=function() {
		return 		'  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_registerEmployee_address">'
+		'		Library_registerEmployee:'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_registerEmployee_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_registerEmployee_address" onclick="'+this.prefix+'LibraryController.Library_registerEmployee_address()">execute Library_registerEmployee</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_registerEmployee_address_res"></div>'
...
;
	...
	*/
	this.createLibrary_unregisterEmployee_addressGui=function() {
		return 		'  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_unregisterEmployee_address">'
+		'		Library_unregisterEmployee:'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_unregisterEmployee_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_unregisterEmployee_address" onclick="'+this.prefix+'LibraryController.Library_unregisterEmployee_address()">execute Library_unregisterEmployee</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_unregisterEmployee_address_res"></div>'
...
;
	...
	*/
	this.createLibrary_registerUser_address_stringGui=function() {
		return 		'  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_registerUser_address_string">'
+		'		Library_registerUser:'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_registerUser_address_string__address"></div>'
+		'			  <div class="function_parameter">_name<input type="text" id="'+this.prefix+'Library_registerUser_address_string__name"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_registerUser_address_string" onclick="'+this.prefix+'LibraryController.Library_registerUser_address_string()">execute Library_registerUser</button>'
...
;
	...
	*/
	this.createLibrary_unregisterUser_addressGui=function() {
		return 		'  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_unregisterUser_address">'
+		'		Library_unregisterUser:'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_unregisterUser_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_unregisterUser_address" onclick="'+this.prefix+'LibraryController.Library_unregisterUser_address()">execute Library_unregisterUser</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_unregisterUser_address_res"></div>'
...
;
	...
	*/
	this.createLibrary_addBook_stringGui=function() {
		return 		'  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_addBook_string">'
+		'		Library_addBook:'
+		'			  <div class="function_parameter">_titel<input type="text" id="'+this.prefix+'Library_addBook_string__titel"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_addBook_string" onclick="'+this.prefix+'LibraryController.Library_addBook_string()">execute Library_addBook</button>'
+		'			<div class="function_result" id="'+this.prefix+'Library_addBook_string_res"></div>'
...
;
	...
	*/
	this.createLibrary_changeBookState_uint_uintGui=function() {
		return 		'  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_changeBookState_uint_uint">'
+		'		Library_changeBookState:'
+		'			  <div class="function_parameter">id<input type="number" id="'+this.prefix+'Library_changeBookState_uint_uint_id"></div>'
+		'			  <div class="function_parameter">_state<input type="number" id="'+this.prefix+'Library_changeBookState_uint_uint__state"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_changeBookState_uint_uint" onclick="'+this.prefix+'LibraryController.Library_changeBookState_uint_uint()">execute Library_changeBookState</button>'
...
;
	...
	*/
	this.createLibrary_borrowBook_uint_addressGui=function() {
		return 		'  <div class="function_execution" id="'+this.prefix+'Library_contract_function_Library_borrowBook_uint_address">'
+		'		Library_borrowBook:'
+		'			  <div class="function_parameter">id<input type="number" id="'+this.prefix+'Library_borrowBook_uint_address_id"></div>'
+		'			  <div class="function_parameter">_address<input type="text" id="'+this.prefix+'Library_borrowBook_uint_address__address"></div>'
+		'			<button id="'+this.prefix+'LibraryController.Library_borrowBook_uint_address" onclick="'+this.prefix+'LibraryController.Library_borrowBook_uint_address()">execute Library_borrowBook</button>'
	...
	*/
	this.createStruc_Library_contract_attribute_usersGui=function(struct) {
		return '<div class="Struct_Mapping" id='+this.prefix+'"Struc_Library_contract_attribute_users">'
    		+'<div class="Struct_attribute" id='+this.prefix+'"Library_contract_attribute_users_userState"> userState:'
      		+'	<div class="Struct_attribute_value" id='+this.prefix+'"Library_users_userState_value">'+struct.userState()+'</div>'
    		+'</div>'
    		+'<div class="Struct_attribute" id='+this.prefix+'"Library_contract_attribute_users_userName"> userName:'
      		+'	<div class="Struct_attribute_value" id='+this.prefix+'"Library_users_userName_value">'+struct.userName()+'</div>'
    		+'</div>'
    		+'<div class="Struct_attribute" id='+this.prefix+'"Library_contract_attribute_users_userId"> userId:'
      		+'	<div class="Struct_attribute_value" id='+this.prefix+'"Library_users_userId_value">'+struct.userId()+'</div>'
    		+'</div>'
    		+'<div class="Struct_attribute" id='+this.prefix+'"Library_contract_attribute_users_borrowedBooks"> borrowedBooks:'
      		+'	<div class="Struct_attribute_value" id='+this.prefix+'"Library_users_borrowedBooks_value">'+struct.borrowedBooks()+'</div>'
    		+'</div>'
    		+'<div class="Struct_attribute" id='+this.prefix+'"Library_contract_attribute_users_borrowedBooksCount"> borrowedBooksCount:'
      		+'	<div class="Struct_attribute_value" id='+this.prefix+'"Library_users_borrowedBooksCount_value">'+struct.borrowedBooksCount()+'</div>'
    		+'</div>'
  		+'</div>';
	}
	/**
	...
	*/
	this.createStruc_Library_contract_attribute_booksGui=function(struct) {
		return '<div class="Struct_Mapping" id='+this.prefix+'"Struc_Library_contract_attribute_books">'
    		+'<div class="Struct_attribute" id='+this.prefix+'"Library_contract_attribute_books_bookTitel"> bookTitel:'
      		+'	<div class="Struct_attribute_value" id='+this.prefix+'"Library_books_bookTitel_value">'+struct.bookTitel()+'</div>'
    		+'</div>'
    		+'<div class="Struct_attribute" id='+this.prefix+'"Library_contract_attribute_books_bookId"> bookId:'
      		+'	<div class="Struct_attribute_value" id='+this.prefix+'"Library_books_bookId_value">'+struct.bookId()+'</div>'
    		+'</div>'
    		+'<div class="Struct_attribute" id='+this.prefix+'"Library_contract_attribute_books_bookState"> bookState:'
      		+'	<div class="Struct_attribute_value" id='+this.prefix+'"Library_books_bookState_value">'+struct.bookState()+'</div>'
    		+'</div>'
    		+'<div class="Struct_attribute" id='+this.prefix+'"Library_contract_attribute_books_currentOwner"> currentOwner:'
      		+'	<div class="Struct_attribute_value" id='+this.prefix+'"Library_books_currentOwner_value">'+struct.currentOwner()+'</div>'
    		+'</div>'
  		+'</div>';
	}
